# Web Components Tabs Example with Lit
...
## The `TabWrapper` Lit element

[`src/tab-wrapper.js`](./src/tab-wrapper.js) defines a `LitElement` subclass that wraps Carbon's `<cds-tabs>` component.
